									...
									<ul class="widget-users row ps-0 mb-5">
										...
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0  bg-primary-transparent">
													...
													<p>Array adalah variabel khusus yang dapat menampung banyak nilai di bawah satu nama, dan Anda dapat mengakses nilai dengan mengacu pada nomor indeks atau nama.</p>
											</div>
										</li>
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0 bg-primary-transparent">
