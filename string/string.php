									...
									<ul class="widget-users row ps-0 mb-5">
										...
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0  bg-primary-transparent">
													...
													<p>String adalah rangkaian karakter, yang karakternya sama dengan byte . Ini berarti PHP hanya mendukung kumpulan 256 karakter, dan karenanya tidak menawarkan dukungan asli Unicode</p>
											</div>
										</li>
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0 bg-primary-transparent">
