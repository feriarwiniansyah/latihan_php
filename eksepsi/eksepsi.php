									...
									<ul class="widget-users row ps-0 mb-5">
										...
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0  bg-primary-transparent">
													...
													<p>Exception pada PHP adalah sebuah mekanisme yang digunakan untuk menangani kesalahan atau kegagalan yang terjadi selama proses eksekusi program.</p>
											</div>
										</li>
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0 bg-primary-transparent">
													<div class="card-body text-left text-black">
														<h5>CONTOH Eksepsi</h5>
														<hr>
														<!-- syntax php -->
														<?php
