									...
									<ul class="widget-users row ps-0 mb-5">
										...
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0  bg-primary-transparent">
													...
													<p>ontrol Structure merupakan suatu algoritma program yang memiliki suatu kondisi yang dimana kondisi tersebutlah yang akan menentukan pengambilan keputusan atau perintah yang akan dijalankan</p>
											</div>
										</li>
										<li class="col-xl-4 col-lg-6  col-md-6 col-sm-12 col-12">
											<div class="card border p-0 bg-primary-transparent">
													<div class="card-body text-left text-black">
														<h5>CONTOH Kontrol Program</h5>
														<hr>
														<!-- syntax php -->
															<?php
																$favcolor = "red";
